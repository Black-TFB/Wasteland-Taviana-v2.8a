player createDiarySubject ["[=TFB=] Information", "[=TFB=] Information"];
player createDiarySubject ["[=TFB=] Server Rules", "[=TFB=] Server Rules"];
player createDiarySubject ["[=TFB=] Changelog", "[=TFB=] Change Log"];
player createDiarySubject ["changelog", "Change Log"];
player createDiarySubject ["wasteland", "What is Wasteland?"];

player CreateDiaryRecord["[=TFB=] Server Rules",
[
"Server Rules",
"
<br/>
		1. NO Global Chat or VOIP - This is to reach an admin only<br/>
		2. NO Team Killing on Blufr or Opfor<br/>
		3. Be Mature in Chat - Keep Swearing to a minimum<br/>
		4. NO Racism<br/>
		5. NO VOIP Abuse<br/>
		6. NO Spamming or Advertising<br/>
		7. NO Whining, Complaining, or Bitching<br/>
		8. RESPECT ALL PLAYERS AND ADMINS<br/>
"
]
];

Player CreateDiaryRecord["[=TFB=] Changelog",
[
"Black Edition",
"
<br/>
		...
		[Added] - Backpacks<br/>
		[Added] - Choppers now set to  variable % at start<br/>
		[Added] - TFB information to briefing<br/>
		[Added] - No Damage to some gas stations<br/>
		[Added] - Script to static heli spawns removing fuel and health<br/>
		[Added] - MK16 to us basic weapons box<br/>
		...
		[Added] - BAF_Merlin to static spawn list<br/>
		[Added] - Blackout Screen for some TWS weapons<br/>
		[Fixed] - Backpacks player respawns with weapons in hand. Now only respawns with weapon in backpack<br/>
		[Fixed] - Backpacks now call at mission start not on trigger at player spawn<br/>
		[Adjusted] - M110 TWS and MK17 TWS Prices<br/>		
"
]
];

Player CreateDiaryRecord["[=TFB=] Information",
[
"Enjoy this Server?",
"
<br/>
		If you enjoy this server or any of the other Task Force Blackjack servers please help to keep them up and running by making a donation. Every little bit helps, and we greatly apreciate your donations. Please visit http://tf-blackjack.com/misc.php?do=donate to help keep this server up and running.
"		
]
];
...
"
<br/>		
		So you are interested in Task Force BlackJack, please visit http://tf-blackjack.com/recruit/index.php for more information
"
]
];
...
"
<br/>
		Task Force Blackjack [=TFB=]<br/><br/>
		Team Speak: 206.217.140.50<br/><br/>
		Website: www.tf-blackjack.com
"
]
];
...
<br/>
 ...
 Developer - Pulse<br/><br/>
	Porter/Tweakers:<br/><br/>
	Porter/Tweaker - SGT Black<br/><br/>
	Server Host:<br/><br/>
	Host - Task Force Blackjack<br/>
"
]
];
...
<br/>
	...
	Suspect a player is hacking or exploiting? Please report it at: http://www.tf-blackjack.com<br/><br/>
...
<br/>
	...
	Teamspeak IP: 206.217.140.50<br/><br/>
